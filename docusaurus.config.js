...
const config = {
  ...
  organizationName: 'fredgraybealsd', // Usually your GitHub org/user name.
  projectName: 'sd-docusaurus', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {to: '/code-snippets', label: 'Code-Snippets', position: 'left'},
          {
            to: '/playground/',
